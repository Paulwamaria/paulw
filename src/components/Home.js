        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-md-6 #9699bb">
              ...
              <h3 className="text-center text-white funnyFonts mb-2">
              ...
              <div className=" text-white hoverLight overflow-auto mt-3">
                ...
                <div className="card-body pl-5 mt-3">
                  <p>
                    ...
                    technologies such as Python, Javascript, Django, React,
                    Flask, Angular, React-redux among others. I am also
                    comfortable creating and consuming APIs. Recently, I have
                    developed a keen interest in cloud services. Exercising is
                    my way of decompressing. If I am not coding, or by any
                    chance, if I need to get away from the bugs for a while,
                    you’ll either find me on a yoga mat stretching. I consider
                    having a growth mindset as my greatest asset because it
                    compels me to seek a challenging and dynamic environment
                    where I can grow.
                  </p>
                </div>
              </div>
